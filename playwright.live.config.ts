...
const LIVE_URL = 'https://postern.allmymind.org';
...
// Proves the live deployment, not a local build: no webServer here, this
// hits https://postern.allmymind.org directly. Run with `npm run test:e2e:live`.
